$(document).ready(function() {
    ...
    $("#new-product").on("click", function () {
        ...
        $('#input-product-manufacturer').val("");
        $("#input-product-category").val("");
        $("#input-product-amount").val("");
        $("#input-product-price").val("");
        $("#input-product-release-date").val("");
        $("#input-product-color").val("");
    ...
    $(".edit-product").on("click", function () {
        ...
        axios.get("/api/product/detail/" + pdInfo).then(function(res){
            ...
            if(res.data.success) {
                ...
                $("#input-product-manufacturer").val(res.data.data.manufacturerId);
                ...
                $("#input-product-release-date").val(res.data.data.realseDate);
    ...
    $(".btn-save-product").on("click", function () {
        ...
        dataProduct.manufacturerId = $('#input-product-manufacturer').val();
        ...
        dataProduct.realseDate = $("#input-product-release-date").val();
